...
# Evaluate SmolVLA on LIBERO-Spatial with LeRobot's built-in evaluator.
# Usage:
#   bash eval_smolvla_libero_spatial.sh
# Optional overrides:
#   DATASET_ROOT=~/libero_dataset MODEL_ID=HuggingFaceVLA/smolvla_libero N_EPISODES=10 BATCH_SIZE=1 bash eval_smolvla_libero_spatial.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-./outputs/eval/smolvla_libero_spatial}"
